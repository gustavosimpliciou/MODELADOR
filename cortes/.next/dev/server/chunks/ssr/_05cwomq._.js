...
async function loadSTLFromBuffer(buffer) {
    const { STLLoader } = await __turbopack_context__.A("[project]/node_modules/three/examples/jsm/loaders/STLLoader.js [app-ssr] (ecmascript, async loader)");
    return new STLLoader().parse(buffer);
}
async function loadOBJFromText(buffer) {
    const { OBJLoader } = await __turbopack_context__.A("[project]/node_modules/three/examples/jsm/loaders/OBJLoader.js [app-ssr] (ecmascript, async loader)");
...
async function loadPLYFromBuffer(buffer) {
    const { PLYLoader } = await __turbopack_context__.A("[project]/node_modules/three/examples/jsm/loaders/PLYLoader.js [app-ssr] (ecmascript, async loader)");
...
//# sourceMappingURL=_05cwomq._.js.map