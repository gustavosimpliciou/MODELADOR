...
function TopBar({ onExport }) {
    ...
    /**
   * Processa um File já obtido (seja via picker ou drag-drop).
   * Exportada via window para que o viewport possa chamar também.
   */ async function processFile(file) {
    ...
    /**
   * Abre o file picker usando a estratégia mais confiável disponível.
   * Chamado SINCRONAMENTE do onClick — mantém o "user gesture" ativo.
   */ function handleOpenClick() {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$open$2d$file$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["openFile"])().then(processFile).catch((err)=>{
            // AbortError = usuário cancelou — silencioso
            if (err?.name === 'AbortError' || err?.message === 'Cancelled') return;
            console.error('[Cortes] openFile falhou:', err);
            setStatus('error', t.load_error(err?.message ?? 'Erro ao abrir arquivo'));
        });
    }
    const handleQuit = ()=>{
        setQuitOpen(false);
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ViewToggleBtn, {
                                ...
                                title: allowCutPartSelection ? 'Seleção de peças cortadas: LIBERADA' : 'Seleção de peças cortadas: BLOQUEADA'
                            }, void 0, false, {
                                fileName: "[project]/components/layout/top-bar.tsx",
                                lineNumber: 174,
                                columnNumber: 11
...
_s(TopBar, "TGvsCxHpEHneGTfmuecAzrH//Mo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$lang$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useT"],
...
//# sourceMappingURL=_07u5nzt._.js.map