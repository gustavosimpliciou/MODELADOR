...
function TopBar({ onExport }) {
    ...
    // Ref para o input — listener nativo captura o change (React 19 não é confiável)
    ...
    const handleFile = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TopBar.useCallback[handleFile]": async (file)=>{
    ...
    // Listener nativo — ignora o sistema de eventos sintéticos do React 19
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TopBar.useEffect": ()=>{
            const input = fileInputRef.current;
            if (!input) return;
            const onNativeChange = {
                "TopBar.useEffect.onNativeChange": (e)=>{
            ...
            }["TopBar.useEffect.onNativeChange"];
            input.addEventListener('change', onNativeChange);
            return ({
                "TopBar.useEffect": ()=>input.removeEventListener('change', onNativeChange)
            })["TopBar.useEffect"];
        }
    }["TopBar.useEffect"], [
        handleFile
    ...
    const handleQuit = ()=>{
        setQuitOpen(false);
        // Try to close the tab; fallback: reset workspace
        try {
            window.close();
        } catch  {}
        // If window.close() didn't work, reset app state
...
_s(TopBar, "10SfYo2GNf6m+tPrQHTn1i+LDV4=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$lang$2d$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useT"],
...
_s3(Viewport3D, "8kdKB/s/mWJ8sk104aRbglM/0sk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAppStore"]
    ];
});
...
//# sourceMappingURL=_0vs8r0d._.js.map