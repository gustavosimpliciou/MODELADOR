...
function buildCaps(
  ...
  for (const oi of outers) {
    ...
    if (holeLoops.length === 0) {
      ...
      negCap = generateCapWithHoles(outerPts, holeLoops, n, u, v, planePoint, false)
      posCap = generateCapWithHoles(outerPts, holeLoops, n, u, v, planePoint, true)
    }
    ...
    for (let t = 0; t < negCount; t++) {
      const o = t * 9
      negative.pos.push(
        negCap.pos[o],   negCap.pos[o+1], negCap.pos[o+2],
        negCap.pos[o+3], negCap.pos[o+4], negCap.pos[o+5],
        negCap.pos[o+6], negCap.pos[o+7], negCap.pos[o+8],
      )
      negative.nrm.push(
        negCap.nrm[o],   negCap.nrm[o+1], negCap.nrm[o+2],
        negCap.nrm[o+3], negCap.nrm[o+4], negCap.nrm[o+5],
        negCap.nrm[o+6], negCap.nrm[o+7], negCap.nrm[o+8],
      )
    }
    ...
    for (let t = 0; t < posCount; t++) {
      const o = t * 9
      positive.pos.push(
        posCap.pos[o],   posCap.pos[o+1], posCap.pos[o+2],
        posCap.pos[o+3], posCap.pos[o+4], posCap.pos[o+5],
        posCap.pos[o+6], posCap.pos[o+7], posCap.pos[o+8],
      )
      positive.nrm.push(
        posCap.nrm[o],   posCap.nrm[o+1], posCap.nrm[o+2],
        posCap.nrm[o+3], posCap.nrm[o+4], posCap.nrm[o+5],
        posCap.nrm[o+6], posCap.nrm[o+7], posCap.nrm[o+8],
      )
    }
