...
export const translations = {
  pt: {
    ...
    coupon_benefit_credits: 'BÔNUS SURPRESA',
    coupon_benefit_days: 'valor revelado ao resgatar o código',
    ...
    coupon_success: (c: number) => `${c} créditos adicionados!`,
  ...
  en: {
    ...
    coupon_benefit_credits: 'MYSTERY BONUS',
    coupon_benefit_days: 'value revealed on redeem',
    ...
    coupon_success: (c: number) => `${c} credits added!`,
  ...
  es: {
    ...
    coupon_benefit_credits: 'BONO SORPRESA',
    coupon_benefit_days: 'valor revelado al canjear el código',
    ...
    coupon_success: (c: number) => `¡${c} créditos añadidos!`,
    ...
    upgrade_features_premium: [
      ...
      'Todos los modelos 3D',
      'Texturas premium ilimitadas',
      'Funciones beta y exclusivas',
      'Soporte prioritario',
      'Actualizaciones anticipadas',
      'Uso comercial permitido',
    ],
    upgrade_footer: [
      { title: '¿CÓMO FUNCIONAN LOS CRÉDITOS?', desc: 'Cada descarga usa 40 créditos. Sigues creando y editando con normalidad.' },
      { title: 'CREA SIN LÍMITES', desc: 'Diseña, edita y visualiza todos los modelos que quieras.' },
